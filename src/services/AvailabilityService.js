...
export class AvailabilityService {
     ...
     */
    static async checkAvailability(businessId, date, time, partySize = 2, durationMinutes = null) {
        try {
     ...
     */
    static async generateAvailabilitySlots(businessId, startDate, endDate = null) {
        try {
     ...
     */
    static async getAvailabilitySlots(businessId, date, status = 'free') {
        try {
            let query = supabase
     ...
     */
    static async getAvailableTimeSlots(businessId, date, partySize = 2) {
        try {
    ...
    static async createSpecialEvent({
        ...
        try {
            ...
            await this.generateAvailabilitySlots(businessId, startDate, endDate);
