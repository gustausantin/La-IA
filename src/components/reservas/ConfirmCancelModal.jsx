            ...
            <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4 shadow-2xl">
                ...
                <div className="mb-6 space-y-4">
                    <p className="text-gray-700 font-medium">
                        Esta reserva se <strong>cancelará</strong> y el horario quedará libre para nuevas reservas.
                    </p>
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="flex-1 px-4 py-2.5 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors font-semibold shadow-lg"
                    >
                        SÍ, CANCELAR
                    </button>
                </div>
