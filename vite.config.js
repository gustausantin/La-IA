...
export default defineConfig({
  ...
  server: {
    ...
    headers: {
      'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob:; worker-src 'self' blob:; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https: https://*.supabase.co; media-src 'self' https://*.supabase.co; font-src 'self' data:; connect-src 'self' http://localhost:* http://127.0.0.1:* https://*.supabase.co wss://*.supabase.co ws://localhost:* ws://127.0.0.1:* https://*.n8n.cloud;",
